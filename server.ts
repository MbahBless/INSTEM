  ...
  applications: [
    {
      ...
      companyName: "Goldman Tech Solutions",
      studentId: "student_1",
      studentName: "Lechindem Mbah Bless",
  ...
  reports: [
    {
      ...
      status: "APPROVED",
      feedback: "Excellent work Lechindem. Your code structure is modular and typography alignments look clean! Keep it up.",
      grade: "A"
    }
  ],
  notifications: [
...
**Student Name:** ${userName || "Lechindem Mbah Bless"}
